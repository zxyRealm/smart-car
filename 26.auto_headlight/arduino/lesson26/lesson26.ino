...
QXMBOT1_AHA_sensor  g_QXMBOT1_AHA_sensor1(A0, INPUT_PULLUP);

QXMBOT1_headlight g_QXMBOT1_headlight1(A1);
...
void loop()
{
  ...
  if ((HIGH == g_QXMBOT1_AHA_sensor1.getAHA_sensorStatus())) {
    g_QXMBOT1_headlight1.headlightON(A1);

  } else {
    g_QXMBOT1_headlight1.headlightOFF(A1);
